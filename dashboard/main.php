        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
                <a href="#" class="app-brand-link">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Financi</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- <li class="menu-item <?php
                                        ...
                                        ?>">
                    <a href="main.php?page=budget" class="menu-link">
                ...
                <!-- <li class="menu-item <?php
                                        ...
                                        ?>">
                    <a href="main.php?page=customize" class="menu-link">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <span class="fw-semibold d-block">Adzka SFR</span>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                        <div class="mb-2 mb-md-0">
                            ©2023, by
                            <a href="https://kaadzka.com" target="_blank" class="footer-link fw-bolder">Adzka SFR&#129305;</a>
                        </div>
                    </div>
                </footer>
                <!-- / Footer -->
